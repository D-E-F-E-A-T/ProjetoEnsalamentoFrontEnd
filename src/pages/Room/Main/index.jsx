                    ...
                    {room.map((room, index) => (
                        <TableRow key={index}>
                            ...
                            <TableCell align="center">
                                <Button href={"building/details/" + room.id} className={classes.button}>
                                    Detalhes
                                </Button>
                                <Button href={"building/update/" + room.id} className={classes.button}>
                                    Alterar
                                </Button>
                                <Button href={"building/delete/" + room.id} className={classes.button}>
                                    Delete
                                </Button>
                            </TableCell>
                        </TableRow>
